...
SnapshotSchema.index({ id: 1 }); // Index for the unique ID
SnapshotSchema.index({ cmc_rank: 1 });
SnapshotSchema.index({ symbol: 1 });
SnapshotSchema.index({ slug: 1 });
SnapshotSchema.index({ last_updated: 1 });
